...
public class bill extends AppCompatActivity {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (swPayed.isChecked()){
                    ...
                    Toast toast = Toast.makeText(getApplicationContext(), "First check Payed switch", Toast.LENGTH_SHORT);
                    toast.show();
                }
    ...
    public void initialize(){
        ...
        swPayed = (Switch) findViewById(R.id.ispaid);
